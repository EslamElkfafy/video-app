...
import { dislike, fetchFailured, fetchStart, fetchSuccessed, like } from "../redux/videoSlice";
  ...
  useEffect(() => {
    ...
    const fetchVideoData = async () => {
      try {
        ...
        dispatch(fetchSuccessed(videoRes.data))
      } catch (error) {
        dispatch(fetchFailured())
      }
    ...
    <Container>
      <Content>
        ...
        <Channel>
          ...
          <Subscribe onClick={handleSubscribe}>{currentUser.subscribedUsers?.includes(currentChannel._id) ? "SUBSCRIBED" : "SUBSCRIBE"}</Subscribe>
        </Channel>
        <Hr />
